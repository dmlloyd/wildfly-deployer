 ...
 */
public final class DeployerChainBuildException extends Exception {
     ...
     *
     */
    public DeployerChainBuildException() {
    }
     ...
     */
    public DeployerChainBuildException(final String msg) {
        super(msg);
    }
     ...
     */
    public DeployerChainBuildException(final Throwable cause) {
        super(cause);
    }
     ...
     * @param cause the cause
     */
    public DeployerChainBuildException(final String msg, final Throwable cause) {
        super(msg, cause);
    }
}
